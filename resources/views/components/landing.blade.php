...
<section class="space-y-12 mb-14">
    ...
    <div class="border border-[#EAEAEA] dark:border-[#222222] bg-white dark:bg-[#141414] rounded-[8px] p-8 sm:p-14 relative overflow-hidden">
        <div class="max-w-3xl space-y-4">
            ...
            <h1 class="font-serif text-3xl sm:text-5xl font-normal tracking-tight text-[#111111] dark:text-[#EDEDEC] leading-[1.15]">
                Suarakan realitas fasilitas publik tanpa birokrasi berbelit.
            </h1>

            <p class="text-xs sm:text-sm text-[#787774] dark:text-[#9B9B97] leading-relaxed font-sans max-w-2xl">
            ...
            <div class="pt-4 flex flex-wrap items-center gap-3 font-mono text-xs">
        ...
        <!-- Metric Ledger Bar -->
        <div class="mt-10 pt-8 border-t border-[#EAEAEA] dark:border-[#222222] grid grid-cols-2 sm:grid-cols-3 gap-6 font-mono">
            <div>
